...
pcut1_lower = 128 #0.3, 0.8, ~1.3, 2.5, 8
pcut1_upper = 132

dEdxCut_lower = 22.6
dEdxCut_upper = 22.4

smearing = 1.5524175 /100 #10**4
...
"""
data_final['P_good'] = np.random.normal(loc = data_final['P_true'], 
                                        scale = 0.037 * data_final['P_true'] * (1e-3))

data_final['dEdx_trunc_sm'] = np.random.normal(loc = data_final['dEdx_trunc'], 
                                          scale = smearing * data_final['dEdx_trunc'])
...
Cut_dEdx = data_final[(data_final['dEdx_trunc'] > dEdxCut_lower) & (data_final['dEdx_trunc'] < dEdxCut_upper)]
#PLOT==========================================================================
...
#Cut in dEdx
CutdEdx_muon = Cut_dEdx[Cut_dEdx['ID'] == 0]
CutdEdx_pion = Cut_dEdx[Cut_dEdx['ID'] == 1]
CutdEdx_kaon = Cut_dEdx[Cut_dEdx['ID'] == 2]
CutdEdx_proton = Cut_dEdx[Cut_dEdx['ID'] == 3]
CutdEdx_electron = Cut_dEdx[Cut_dEdx['ID'] == 4]
...
"""
axs[0].hist2d(data_final['P_good'], data_final['dEdx_trunc_sm'],bins=(x_space, y_space), cmin=1,cmap = "jet")
axs[0].set_xlabel('P (MeV/c)', fontsize = 30 )
axs[0].set_ylabel('dE/dx (keV/cm)', fontsize = 30 )
axs[0].axvspan(pcut1_lower, pcut1_upper, color='grey', alpha=0.5)
axs[0].set_xscale('log')
axs[0].set_xlim([100,8000])
axs[0].set_ylim([10.5,25])
...
axs[0].set_xlabel('P (MeV/c)', fontsize = 30 )
axs[0].set_ylabel('dE/dx (keV/cm)', fontsize = 30 )
axs[0].axvspan(pcut1_lower, pcut1_upper, color='green', alpha=0.75)
axs[0].set_xscale('log')
axs[0].set_xlim([100,8000])
axs[0].set_ylim([10.5,25])
...
axs[1].set_xlabel('dEdx (keV/cm)', fontsize = 30)
